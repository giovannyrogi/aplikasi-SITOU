...
/** Membaca payload JSON dan file dari satu request multipart dengan format error yang sama. */
export const readMultipartJson = async (
  request,
  schema,
  requestId,
  { payloadField = "payload", fileField = "file" } = {},
) => {
  try {
    ...
    if (typeof rawPayload !== "string")
      return {
        ...
        response: errorResponse(
          ...
          "Payload formulir tidak ditemukan.",
          400,
          requestId,
          { [payloadField]: "Payload formulir wajib diisi." },
        ),
      };
