...
export function buildReportQuery(
  ...
  const text = `WITH base AS (
    SELECT e.id AS employee_id,e.employee_no,e.full_name,e.birth_date,e.joined_date,e.employment_status,
  ...
  page AS (SELECT id::text,employee_id::text,employee_no,full_name,location_name,unit_name,position_name,
