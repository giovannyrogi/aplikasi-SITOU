...
/** Schema NIK wajib dipakai pada profil pegawai yang disimpan permanen. */
export const requiredIndonesianNationalIdSchema = z.preprocess(
  normalizeIndonesianNationalId,
  z.string({ error: "NIK wajib diisi." }).regex(/^\d{16}$/, INDONESIAN_NATIONAL_ID_MESSAGE),
);
